...
public class Barn  {
	...
	//Barn class is not extending any class
	// just creating Animal object 
	//Dog object
	//Puppy object & cat object
	...
	public static void main(String[] args) {
		...
		//when creating an object of the parent class
		//we don't have access to the child class features and behaviors
